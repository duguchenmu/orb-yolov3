...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="models/yolov3-tiny_bam.yaml", help="model.yaml path")
    ...
    parser.add_argument("--project", default=ROOT / "runs/train/mydata", help="save to project/name")
